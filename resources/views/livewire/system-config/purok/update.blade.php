<div class="py-6">
    <div class="max-w-4xl px-6 mx-auto md:px-8">
        <div class="text-2xl font-semibold text-gray-700 ">
            ...
            <div>
                <form enctype="multipart/form-data" wire:submit="updatePurok">
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input.floating wire:model='purok_name' class="mt-4 border-gray-500" :value="'Purok name'"
                                :name="'purok_name'" :id="'purok_name'" :type="'text'" :bg="'white'" />
