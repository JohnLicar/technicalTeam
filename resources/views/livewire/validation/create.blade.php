                    ...
                    <form enctype="multipart/form-data" wire:submit="addNewRecord">
                        <div>
                            ...
                            <div class="grid grid-cols-1 mt-3 md:grid-cols-2 gap-y-4 gap-x-4">
                                ...
                                <div class="relative">
                                    <select wire:model.live='purok_id' name="purok" id="purok"
                                        class="block w-full p-3 text-sm text-gray-900 bg-transparent border-gray-500 rounded-lg appearance-none border-1 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                        <option value="" selected>
                            ...
                            <div class="grid grid-cols-1 gap-4 mt-3 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-4">
                                        <select wire:model='validated_by' required name="validated_by" id="validated_by"
                                            class="block w-full p-3 text-sm text-gray-900 bg-transparent border-gray-500 rounded-lg appearance-none border-1 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                            <option value="" selected>
                                                Select Validator
                                            </option>
                        ...
                        <div x-data={show:false}>
                            <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 ">
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 my-4 md:grid-cols-2">
                                        <div class="flex mt-2">
                                            <input wire:model.live='resettlement' value=1 @click="show = true"
                                                name="resettlement" id="with_resettlement" type="radio"
                                                class="text-blue-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                        ...
                                        <div class="flex mt-2">
                                            <input wire:model.live='resettlement' value=0 @click="show = false"
                                                name="resettlement" id="no_resettlement" type="radio"
                                                class="text-blue-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                            ...
                            <div x-show="show" class="grid grid-cols-1 gap-2 my-4 md:grid-cols-4 sm:grid-cols-2">
                                <div class="relative">
                                    <select wire:model='site' name="site" id="site"
